...
class shutit_test(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send_host_file('/root/.ssh/id_rsa','/home/imiell/.ssh/id_rsa.pub')
		shutit.send('chmod 0400 /root/.ssh/id_rsa')
		shutit.send('git clone --depth=1 -b ' + shutit_branch + ' git@github.com:ianmiell/shutit && cd shutit')
		...
		output = shutit.send_and_get_output('coverage html')
		shutit.send('git add htmlcov')
